    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src=<?= $p["url_img"] ?> alt="Image">
                        </div>
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold"><?= $p["tensanpham"] ?></h3>
                ...
                <h3 class="font-weight-semi-bold mb-4"><?= $p["dongia"] ?>đ</h3>
                <p class="mb-4"><?= $p["motasanpham"] ?></p>
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    <div class="input-group quantity mr-3" style="width: 130px;">
                        ...
                        <input type="text" class="form-control bg-secondary text-center" name="num-buy" id="num-buy" value="1">
                        <div class="input-group-btn">

...
<body>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="container-fluid pt-5">
            ...
            <div class="d-flex row px-xl-5 pb-3">
                <div class=" col-lg-4 col-md-6 col-sm-12 pb-1" style="display: -webkit-box;">
                    <!--Product item start -->
                    <?php
                    ...
                    ?>
                        <div class="card product-item borde r-0 mb-4">
                            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="<?= $hinhanh ?>" alt="">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3"> <?= $p["tensanpham"] ?></h6>
                                <div class="d-flex justify-content-center">
                                    <h6> <?= $p["dongia"] ?>đ</h6>
                                    <h6 class="text-muted ml-2"><del> <?= $p["dongia"] ?></del>đ</h6>
                                </div>
                            </div>
